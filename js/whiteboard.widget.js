...
(function() {
    ...
    var eraserHandler = {
        ...
        mousedown: function(e) {
            ...
            tempContext.lineCap = 'round';
            eraserDrawHelper.line(tempContext, [t.prevX, t.prevY, x, y]);
    ...
    eraserDrawHelper.getOptions = function() {
        return [pencilLineWidth, strokeStyle, fillStyle, globalAlpha, globalCompositeOperation, lineCap, lineJoin, font];
    };
        ...
        mouseup: function(e) {
            ...
            if (g.ismousedown) {
                if (!g.isCircleDrawn && g.isCircledEnded) {
                    ...
                    arcRangeContainer.style.top = (y + 20) + 'px';
    ...
    (function() {
        ...
        function decoratePencil() {
            ...
            addEvent(canvas, 'click', function() {
                ...
                pencilContainer.style.top = (0) + 'px';
        ...
        function decorateMarker() {
            ...
            addEvent(canvas, 'click', function() {
                ...
                markerContainer.style.top = (0) + 'px';
        ...
        function decorateLineWidth() {
            ...
            addEvent(canvas, 'click', function() {
                ...
                lineWidthContainer.style.top = (0) + 'px';
        ...
        function decorateColors() {
            ...
            addEvent(canvas, 'click', function() {
                ...
                colorsContainer.style.top = (0) + 'px';
        ...
        function decorateAdditionalOptions() {
            ...
            addEvent(canvas, 'click', function() {
                ...
                additionalContainer.style.top = (0) + 'px';
